...
def test_buy_and_sell_nikes_adidas():
	...
	# remove 1 sweatpant to sell to the next customer
...
@pytest.mark.parametrize('name, quantity, exception, new_quantity, new_total', [
	...
	('Not Here', 5, ItemNotFoundException('Could not find Not Here in our stocks. Cannot remove a non-existing stock'), 0, 0),
	('Puma Test', 25, InvalidQuantityException('Cannot remove 25 items. Only 8 items are in stock'), 0, 0),
